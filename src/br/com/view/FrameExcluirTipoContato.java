 ...
 * @author William
 */
public class FrameExcluirTipoContato extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameExcluirTipoContato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
